...
processos = [Processo(1, ('localhost', 5000)),
Processo(2, ('localhost', 5001)),
Processo(3, ('localhost', 5002))]

servidor_5000 = Servidor(('localhost', 5000))
servidor_5001 = Servidor(('localhost', 5001))
servidor_5002 = Servidor(('localhost', 5002))

if __name__ == "__main__":
    p1 = Processo(1, ('localhost', 5000))
    p2 = Processo(2, ('localhost', 5001))
    p3 = Processo(3, ('localhost', 5002))
    p4 = Processo(4, ('localhost', 5003))
